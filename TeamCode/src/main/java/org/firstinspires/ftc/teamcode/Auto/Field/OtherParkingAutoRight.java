...
@Autonomous(name= "Other Right Parking Auto")
public class OtherParkingAutoRight extends LinearOpMode {
...
//
    ...
    void ACTI(){
        ...
        sleep(5);
        Bot.driveStraight(125,.6, 180,this);
        sleep(5);
        Bot.distance.getDistance(DistanceUnit.CM);
        Bot.SensorStrafeDrive(50,.2,30,this); //distance was 37
        int i=0;
//        while(i++<500) {
